...
| LunaBridge Paper / Velocity | `0.3.0-beta.17` |
...
- `LunaChat.jar`
- `lunabridge-paper-standalone-0.3.0-beta.17.jar`
...
- `lunabridge-velocity-0.3.0-beta.17.jar`
...
| `lunabridge-paper-standalone-0.3.0-beta.17.jar` | standalone Paperのみ | Discord connector |
| `lunabridge-velocity-0.3.0-beta.17.jar` | Velocityのみ | network構成のDiscord connector |
