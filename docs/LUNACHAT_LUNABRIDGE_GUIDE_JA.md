...
| LunaBridge Paper / Velocity | `0.3.0-beta.7` |
...
- `LunaChat.jar`
- `lunabridge-paper-standalone-0.3.0-beta.7.jar`
...
- `lunabridge-velocity-0.3.0-beta.7.jar`
...
| `lunabridge-paper-standalone-0.3.0-beta.7.jar` | standalone Paperのみ | Discord connector |
| `lunabridge-velocity-0.3.0-beta.7.jar` | Velocityのみ | network構成のDiscord connector |
