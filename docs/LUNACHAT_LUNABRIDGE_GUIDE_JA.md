...
| LunaBridge Paper / Velocity | `0.3.0-beta.6` |
...
- `LunaChat.jar`
- `lunabridge-paper-standalone-0.3.0-beta.6.jar`
...
- `lunabridge-velocity-0.3.0-beta.6.jar`
...
| `lunabridge-paper-standalone-0.3.0-beta.6.jar` | standalone Paperのみ | Discord connector |
| `lunabridge-velocity-0.3.0-beta.6.jar` | Velocityのみ | network構成のDiscord connector |
