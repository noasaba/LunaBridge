...
| LunaBridge Paper / Velocity | `0.3.0-beta.19` |
...
- `LunaChat.jar`
- `lunabridge-paper-standalone-0.3.0-beta.19.jar`
...
- `lunabridge-velocity-0.3.0-beta.19.jar`
...
| `lunabridge-paper-standalone-0.3.0-beta.19.jar` | standalone Paperのみ | Discord connector |
| `lunabridge-velocity-0.3.0-beta.19.jar` | Velocityのみ | network構成のDiscord connector |
