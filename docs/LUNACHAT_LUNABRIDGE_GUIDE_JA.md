...
| LunaBridge Paper / Velocity | `0.3.0-beta.8` |
...
- `LunaChat.jar`
- `lunabridge-paper-standalone-0.3.0-beta.8.jar`
...
- `lunabridge-velocity-0.3.0-beta.8.jar`
...
| `lunabridge-paper-standalone-0.3.0-beta.8.jar` | standalone Paperのみ | Discord connector |
| `lunabridge-velocity-0.3.0-beta.8.jar` | Velocityのみ | network構成のDiscord connector |
