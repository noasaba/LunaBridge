...
| LunaBridge Paper / Velocity | `0.3.0-beta.21` |
...
- `LunaChat.jar`
- `lunabridge-paper-standalone-0.3.0-beta.21.jar`
...
- `lunabridge-velocity-0.3.0-beta.21.jar`
...
| `lunabridge-paper-standalone-0.3.0-beta.21.jar` | standalone Paperのみ | Discord connector |
| `lunabridge-velocity-0.3.0-beta.21.jar` | Velocityのみ | network構成のDiscord connector |
