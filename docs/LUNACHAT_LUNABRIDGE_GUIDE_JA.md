...
| LunaBridge Paper / Velocity | `0.3.0-beta.18` |
...
- `LunaChat.jar`
- `lunabridge-paper-standalone-0.3.0-beta.18.jar`
...
- `lunabridge-velocity-0.3.0-beta.18.jar`
...
| `lunabridge-paper-standalone-0.3.0-beta.18.jar` | standalone Paperのみ | Discord connector |
| `lunabridge-velocity-0.3.0-beta.18.jar` | Velocityのみ | network構成のDiscord connector |
