...
| LunaBridge Paper / Velocity | `0.3.0-beta.16` |
...
- `LunaChat.jar`
- `lunabridge-paper-standalone-0.3.0-beta.16.jar`
...
- `lunabridge-velocity-0.3.0-beta.16.jar`
...
| `lunabridge-paper-standalone-0.3.0-beta.16.jar` | standalone Paperのみ | Discord connector |
| `lunabridge-velocity-0.3.0-beta.16.jar` | Velocityのみ | network構成のDiscord connector |
