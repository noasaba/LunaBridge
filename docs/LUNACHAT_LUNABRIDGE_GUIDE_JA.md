...
| LunaBridge Paper / Velocity | `0.3.0-beta.11` |
...
- `LunaChat.jar`
- `lunabridge-paper-standalone-0.3.0-beta.11.jar`
...
- `lunabridge-velocity-0.3.0-beta.11.jar`
...
| `lunabridge-paper-standalone-0.3.0-beta.11.jar` | standalone Paperのみ | Discord connector |
| `lunabridge-velocity-0.3.0-beta.11.jar` | Velocityのみ | network構成のDiscord connector |
