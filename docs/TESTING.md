...
- token-file precedence, sequential non-destructive migration through schema 5, generation backups, stable-ID setup persistence, and external-publish setup refusal;
